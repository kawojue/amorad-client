    ...
    return (
        <>
            ...
            <div className="flex flex-wrap lg:flex-nowrap gap-5 mt-5">
                ...
                <h2 class="text-sm font-bold text-dark capitalize mb-5">Update Your Company Information</h2>
                    ...
                    >
                        ...
                        {(props) => (
                            ...
                            <Form autoComplete='off'>
                                ...
                                <CustomInput label="Company Name" name="fullname" type="text" placeholder="Ezemmuo Technologie" />
