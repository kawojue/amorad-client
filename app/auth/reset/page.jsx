...
import { ForgotPassword, ResetPasswordSchema } from '@/utils/schema';
                        ...
                        >
                            ...
                            {(props) => (
                                ...
                                <Form autoComplete='off'>
                                    ...
                                    <CustomPassword label="Password" name="password" placeholder="What’s your new password?" />

                                    <CustomPassword label="Confirm Password" name="confirmPassword" placeholder="Confirm new password" />
